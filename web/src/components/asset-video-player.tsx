  ...
  return (
    <section className="rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)] md:p-8">
      <div className="space-y-5">
        <div>
          <div className="text-xs font-medium tracking-[0.18em] text-primary uppercase">{t("demoVideo")}</div>
        ...
        {resolved.length > 1 && (
          <div className="space-y-2">
            <h4 className="text-sm font-semibold text-foreground">{t("allVideos")}</h4>
