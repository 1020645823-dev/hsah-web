    ...
    <footer className="border-t border-border bg-card">
      <div className="mx-auto grid max-w-7xl gap-8 px-6 py-10 md:grid-cols-[1.2fr_0.8fr_0.8fr] md:px-8">
        <div className="space-y-3">
          <p className="text-xs font-medium tracking-[0.18em] text-primary">{t("Footer.aboutHub")}</p>
        ...
        <div className="space-y-3">
          <p className="text-xs font-medium tracking-[0.18em] text-primary">{t("Footer.sections")}</p>
        ...
        <div className="space-y-3">
          <p className="text-xs font-medium tracking-[0.18em] text-primary">{t("Footer.startHere")}</p>
          <div className="flex flex-col gap-1 text-sm text-foreground/70 md:gap-2">
